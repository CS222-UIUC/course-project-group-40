...
config.train_options = {
    ...
    'checkpoint_save_dir': f"./output/ocr/{config.exp_name}/checkpoint",  # 模型保存地址，log文件也保存在这里
    'device': 'cpu',  # 不建议修改 (cpu, cuda:0, cuda:1, ...)
    'epochs': 200,
...
config.dataset = {
    'alphabet': r'dataset/orc/alphabets/digit.txt',
    'train': {
        'dataset': {
