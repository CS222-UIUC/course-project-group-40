...
def cv2pil(image):
    """
    Convert numpy images in BGR format to PIL
...
def get_pil_image(image):
    ...
    :param image:  Image object or ndarray
    :return:       Image object
    """
...
def get_cv_image(image):
    """
    Convert an image to numpy format data
    :param image: Image
...
def pil2cv(image):
    """
    Convert Image object to ndarray format image
